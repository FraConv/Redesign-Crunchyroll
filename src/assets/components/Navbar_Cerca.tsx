    ...
    return(
        <>
            ...
            <div className="grid grid-cols-5 bg-[#284452] w-[100%] absolute top-[-1px] left-0 h-[48px] rounded-br-full rounded-bl-full sm:h-[70px] z-30">
                <div className=" sm:w-[45%] sm:ml-[20%] sm:h-[30%] sm:mt-[3.5%] max-[500px]:hidden">
                <Link to="/"><img className="2xl:mt-[-63%] max-[500px]:hidden xl:mt-[-56%] xl:scale-[115%] 2xl:scale-90" src="crunchyrollv2.svg" alt="" /></Link>
                </div>
                <div className=" ml-[50%] mt-[11px]   w-6 h-6 xl:hidden">
                <img className="" src="crunchyrollv2mobile.svg" alt="" />
                </div>
                ...
                <div className=" w-9 h-9 right-10 top-2 absolute xl:hidden" onClick={ClickIcon}>
                    ...
                    <div className="grid grid-cols-5 absolute left-[18%] ">
                        <div className="hover:bg-[#436d83] max-[500px]:hidden p-[21px] h-[70px] cursor-pointer"><span className="">Esplora{" >"}</span></div>
                        <a className="text-white hover:text-white" href="https://www.crunchyroll.com/it/games/"><div className="h-[70px] hover:bg-[#436d83] max-[500px]:hidden p-[21px] cursor-pointer"><span>Games</span></div></a>
                        <a className="text-white hover:text-white" href="https://store.crunchyroll.com/eu/nl/en?utm_source=web"><div className="h-[70px] hover:bg-[#436d83] max-[500px]:hidden p-[21px] cursor-pointer"><span>Store</span></div></a>
                        <div className="hover:bg-[#436d83]  max-[500px]:hidden p-[21px] cursor-pointer"><span>Notizie{" >"}</span></div>
                    </div>
                    ...
                    <div className="grid grid-cols-4 absolute 2xl:left-[77%] xl:left-[75%] w-[20%]">
                        ...
                        <Link to="/search"><div className="hover:bg-[#436d83] max-[500px]:mt-[-8px] max-[500px]:ml-[1150%]  max-[500px]:w-16 p-[21px] cursor-pointer 2xl:h-[70px] xl:h-[70px]"><img className="2xl:scale-[48%] xl:mt-[5px] 2xl:mt-[-12px] xl:scale-[115%]" src="lente.svg" alt="" /></div></Link>
            ...
            <div className={` w-[380px] h-[150px] absolute mt-[4%] xl:mr-[-100px] 2xl:mr-[1px] right-48 bg-[#223a46] rounded-3xl  transition-all duration-500 ${VisibleInfo ? "translate-y-1" : "translate-y-[-210px]"}`}>
            ...
            <div className={`fixed overflow-y-auto grid grid-cols-1 left-0 h-full w-[100%] z-20 gap-1 bg-[#132027] mt-[-25px] transition-all duration-700 ${HamburgerMenu?"translate-y-[-2000px]":"translate-y-0"}`}>
